...
public class SlidingWindowMiddleware // RateLimitMiddleware<IpRateLimitProcessor>
{

    private readonly RequestDelegate _next;
    private readonly IpRateLimitProcessor _processor;
    private readonly SlidingWindowStrategy _processingStrategy;
    private readonly RateLimitOptions _options;
    private readonly IRateLimitConfiguration _config;

    public SlidingWindowMiddleware(
         RequestDelegate next,
         SlidingWindowStrategy processingStrategy,
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        // 呼叫處理策略 , Sliding Window strategy
